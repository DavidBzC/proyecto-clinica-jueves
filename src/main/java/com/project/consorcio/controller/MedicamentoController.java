...
public class MedicamentoController {
	...
	//Model es una interfaz que permite crear atributos que luego seran enviados a la página
	...
	//@RequestParam, permite recuperar valores que se encuentran en los controles del formulario
	...
	//crear ruta o direccion URL para buscar medicamento segun codigo
